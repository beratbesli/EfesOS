...
- QEMU smoke testi başarılı; varsayılan profilde RTC işaretleri dahil 45 kritik boot/runtime işaretçisi, deterministik ATA/FAT fixture’ında IRQ14 ve DMA bütünlük kanıtı dahil 51 işaretçi doğrulanıyor.
...
- Deterministik 4 MiB FAT16 imajıyla QEMU blok-aygıt/ATA/FAT/journal uçtan uca testi başarılı; RTC, IRQ14, bus-master DMA/PIO veri eşitliği, mount, kök dizin, dosya okuması ve persistent replay dahil 51 işaretçi doğrulanıyor.
...
2. **Donanım kapsamı (P2):** CMOS RTC duvar saati tamamlandı; yeni blok aygıt sözleşmesini kullanarak USB depolama/HID ve ağ sürücülerini, ayrıca APIC/HPET tabanlı yüksek çözünürlüklü monotonic zamanlayıcıyı ekle. Her biri için QEMU/host fixture testi yaz.
