...
- Yeni diskte kalıcı RAMFS başlatmak için `pformat` eklendi; komut yalnızca FAT dışındaki tamamen boş tail bölgesini biçimlendiriyor, dolu veya mevcut journal’ı reddediyor.
