...
Invoke-Tool -Path $linker -Arguments @('-m', 'elf_i386', '-T', $linkerScript, '-o', $kernelElf, $kernelEntryObject, $kernelMainObject, $panicObject, $syscallObject, $languageObject, $splashObject, $vgaObject, $serialObject, $keyboardObject, $pciObject, $idtObject, $pitObject, $systemObject, $interruptObject, $pmmObject, $pagingObject, $heapObject, $schedulerObject, $programsObject, $ramfsObject, $gamesObject, $shellObject) -FailureMessage 'Kernel baglanamadi.'
