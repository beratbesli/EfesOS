...
Invoke-Tool -Path $ld -Arguments @('-m', 'elf_i386', '-T', $linkerScript, '-o', $kernelElf, $kernelEntryObject, $kernelMainObject, $vgaObject, $keyboardObject, $idtObject, $interruptObject, $pmmObject, $pagingObject, $schedulerObject, $shellObject) -FailureMessage 'Kernel baglanamadi.'
