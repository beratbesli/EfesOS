...
Invoke-Tool -Path $linker -Arguments @('-m', 'elf_i386', '-T', $linkerScript, '-o', $kernelElf, $kernelEntryObject, $kernelMainObject, $panicObject, $syscallObject, $ipcObject, $languageObject, $splashObject, $vgaObject, $serialObject, $keyboardObject, $pciObject, $blockDeviceObject, $ataObject, $ataIrqStateObject, $ataDmaObject, $rtcObject, $rtcTimeObject, $acpiTablesObject, $acpiObject, $idtObject, $pitObject, $systemObject, $featuresObject, $interruptObject, $pmmObject, $e820Object, $pagingObject, $heapObject, $schedulerObject, $userProcessObject, $elfLoaderObject, $userDemoObject, $programsObject, $ramfsObject, $journalObject, $persistentObject, $fatObject, $vfsObject, $gamesObject, $shellObject) -FailureMessage 'Kernel baglanamadi.'
