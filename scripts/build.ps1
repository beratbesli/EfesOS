...
Invoke-Tool -Path $ld -Arguments @('-m', 'elf_i386', '-T', $linkerScript, '-o', $kernelElf, $kernelEntryObject, $vgaObject, $keyboardObject, $idtObject, $interruptObject, $pmmObject) -FailureMessage 'Kernel baglanamadi.'
