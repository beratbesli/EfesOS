...
- ATA IRQ state transitions, errors, disabled delivery, polling fallback accounting and sequence wrap are host-tested; CI also attaches a real QEMU IDE disk and requires an IRQ14 completion with zero fallback for the probe.
